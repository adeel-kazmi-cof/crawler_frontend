...
export const changepasswordfield =[
  { text: "Old Password", id: "oldPassword", className: "label-input", type: "text", placeholder: "Enter your old password here", required: true },
  { text: "New Password", id: "newPassword", className: "label-input", type: "text", placeholder: "Enter your new password here", required: true },
  { text: "Confirm Password", id: "confirmPassword", className: "label-input", type: "text", placeholder: "Enter your confirm password", required: true }
];